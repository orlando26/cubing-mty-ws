...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	final static String AUTHORITIES_QUERY = "SELECT cm_user.Email as username, cm_roles.Role as role"
			+ "        FROM cm_user" + "        INNER JOIN cm_user_roles ON cm_user.Id = cm_user_roles.Id_User"
			+ "        INNER JOIN cm_roles ON cm_user_roles.Id_Role = cm_roles.Id" + "        WHERE cm_user.Email = ? ";
